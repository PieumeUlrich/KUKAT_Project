            ...
            <CardContent>
              <InfoRow label="Invoice date"
                value={inv.invoiceDate
                  ? new Date(inv.invoiceDate).toLocaleDateString('en-CA') : null} />
              <InfoRow label="Due date"
                value={inv.dueDate
                  ? new Date(inv.dueDate).toLocaleDateString('en-CA') : null} />
              <InfoRow label="Trip start"
                value={inv.tripStart
                  ? new Date(inv.tripStart).toLocaleDateString('en-CA') : null} />
              <InfoRow label="Trip end"
                value={inv.tripEnd
                  ? new Date(inv.tripEnd).toLocaleDateString('en-CA') : null} />
